...
Maze::Maze()
{
	...
	TileKey map[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, g, _, _, _, _, _, _, w, _, _, _, _, s, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, s, s, s, s, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, s, s, s, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, s, s, s, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, s, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, s, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, s, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, s, w, w, s, w, w, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, s, s, s, s, s, w, s, w, p, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, w, w, w, w, w, s, w, w, w, w, w, _, _, _, _, _, _, _, w },
